...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('profile_image', models.ImageField(blank=True, default=clientApp.models.get_default_profile, max_length=255, null=True, upload_to=clientApp.models.get_profile_image_filepath)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='clientApp.personaldetails')),
            ],
        ),
        migrations.CreateModel(
            name='education',
